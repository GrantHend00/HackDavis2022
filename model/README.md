...
In order to find a suitutable model we tested multiple regression techniques: Random forest, linearRegression and polynomial regression out of which we chose polinomial regression
